 ...
 * 					a Collect process.
 * @param stages The number of {@link groovy_parallel_patterns.functionals.workers.Worker Worker} processes in the pipeline.  Normally there will
 ...
 * @param pDetails A {@link groovy_parallel_patterns.PipelineDetails} object defining any local class of each stage, default to null
