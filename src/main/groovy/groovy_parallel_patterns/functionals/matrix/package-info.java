/**
 * Package groovy_parallel_patterns.functionals.matrix provides a number of matrix based processing engines.
 * Two basic objects are provided<br>
 *     {@link groovy_parallel_patterns.functionals.matrix.Matrix} provides a two-dimensional data structure <br>
 *         {@link groovy_parallel_patterns.functionals.matrix.Vector} provides  a one-dimensional data structure<br>
 *             in addition, programmers can use any form of Groovy List object <p>
 *
 * {@link groovy_parallel_patterns.functionals.matrix.StencilEngine} provides an architecture where the process
 * transforms an input object and then outputs that object, possibly to another StencilEngine process.<br>
 * {@link groovy_parallel_patterns.functionals.matrix.MultiCoreEngine} provides an architecture where the process
