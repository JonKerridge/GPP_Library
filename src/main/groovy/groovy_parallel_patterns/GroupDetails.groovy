 ...
 *
 * @param workers The number of {@link groovy_parallel_patterns.functionals.workers.Worker Worker} processes in the Group
 * @param groupDetails a List of {@code workers} elements each holding the {@link groovy_parallel_patterns.LocalDetails} for each Worker process
 * in the Group
 *
 */
 ...
 * @param workers the number of {@link groovy_parallel_patterns.functionals.workers.Worker} processes in the group
 */
