 ...
 * @param cDetails A List of {@link groovy_parallel_patterns.CompositeDetails} objects containing data pertaining to
 * each group of processes.
 * @param rDetails A list of {@link groovy_parallel_patterns.ResultDetails} , of size groups ,containing data
