...
//    final int writeRequest = 1
	 ...
	 * {@link groovy_parallel_patterns.connectors.spreaders.OneParCastList spreader}process that
...
//	 * {@link groovy_parallel_patterns.cluster.connectors.OneNodeRequestedList}.
//	 *
