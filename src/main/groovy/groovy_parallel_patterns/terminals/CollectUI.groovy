...
import groovy_parallel_patterns.terminals.GUIsupport.*
import groovy_jcsp.*
import jcsp.awt.*
import jcsp.lang.*
 ...
 * @param guiDetails A {@link groovy_parallel_patterns.ResultDetails}  object specifying the result object in which
 * the rCollectmethod updates a DisplayList. It MUST be specified. <p>
 *
