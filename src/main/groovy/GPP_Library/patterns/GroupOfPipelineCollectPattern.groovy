 ...
 * @param rDetails A list of {@link GPP_Library.ResultDetails} , of size groups ,containing data pertaining to result class used by each of the Collect process, it MUST be specified.
 * @param stages The number of stages in the pipeline of processes that will be created
 * 					when the Pipeline is run, not inclussing the final Collect process
