...
public interface DataClassInterface {
	 ...
	 * Clone MUST be implemented if an object is passed through a GPP_Library.connectors.spreaders process that
	 ...
	 * {@link GPP_Library.cluster.connectors.OneNodeRequestedList}.
	 *
