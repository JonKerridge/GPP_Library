...
/**
 * The ListThreePhaseWorkerList process implements a group of {@link GPP_Library.functionals.workers.ThreePhaseWorker} connected
 ...
 * @param lDetails specifies the {@link GPP_Library.LocalDetails} object describing the local worker class used by
 ...
 *
 *
 * @see GPP_Library.functionals.workers.ThreePhaseWorker
 */
