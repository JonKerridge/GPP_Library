package GPP_Library.functionals.transformers
 ...
 * @param localDetails A {@link GPP_Library.LocalDetails} object that specifies the details of a local class
 * @param outDetails A {@link GPP_Library.LocalDetails} object that defines the single output object that results from this process.
