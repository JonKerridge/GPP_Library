 ...
 * @param pDetails A {@link GPP_Library.PipelineDetails} object defining any local class of each stage, default to null
 * @param rDetails A {@link GPP_Library.ResultDetails} object defining the result class used by the Collect process
