 ...
 * @param localDetails A {@link groovyParallelPatterns.LocalDetails} object that specifies the details of a local class
 * @param outDetails A {@link groovyParallelPatterns.LocalDetails} object that defines the single output object that results from this process.
