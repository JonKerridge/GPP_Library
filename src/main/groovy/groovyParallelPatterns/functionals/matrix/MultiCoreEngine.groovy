...
/**
 *
 * MultiCoreEngine creates a process network comprising a {@link groovyParallelPatterns.functionals.matrix.MultiCoreRoot} together with a
 * number of {@link groovyParallelPatterns.functionals.matrix.MultiCoreNode} processes. The goal of the complete process
