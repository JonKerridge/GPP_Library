 ...
 *
 *
 * @see groovyParallelPatterns.functionals.groups.ListGroupCollect* @see groovyParallelPatterns.functionals.groups.ListGroupList* @see groovyParallelPatterns.functionals.workers.Worker* <p>
 *
 */
@CompileStatic
