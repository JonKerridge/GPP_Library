...
/**
 * A ListGroupOfPipelineCollects comprises a network of {@code groups} parallel occurrences and each pipeline comprises
 *  * {@code stages} {@link groovyParallelPatterns.functionals.workers.Worker Worker} processes, excluding the final Collect stage.  Inputs from the preceding process are assumed
 * to come from a ChannelInputList.
 *
