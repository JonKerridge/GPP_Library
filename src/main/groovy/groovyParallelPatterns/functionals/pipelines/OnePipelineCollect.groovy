...
/**
 * 
 * A OnePipelineCollect is a collection of {@link groovyParallelPatterns.functionals.workers.Worker Worker}
 ...
 * @param pDetails A {@link groovyParallelPatterns.PipelineDetails} object defining any local class of each stage, defaults to null
