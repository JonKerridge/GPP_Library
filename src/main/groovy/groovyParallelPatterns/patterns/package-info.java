 ...
 * defines processes that can be used as is simply by making appropriate reference to the data objects used
 ...
 *
 * The application GPP_Demos.MCpi shows how the DataParallelPattern pattern is used with different combinations of data object.
