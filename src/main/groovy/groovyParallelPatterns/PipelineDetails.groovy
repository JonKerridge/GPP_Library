 ...
 * {@link groovyParallelPatterns.LocalDetails} for each Worker process in the Pipeline
 *
 */
@CompileStatic
 ...
 * {@link groovyParallelPatterns.functionals.workers.Worker} processes in the pipeline
 */
