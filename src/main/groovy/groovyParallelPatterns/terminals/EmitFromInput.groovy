 ...
 * have been created the process writes a {@link groovyParallelPatterns.UniversalTerminator} to the output channel.
 * <p>
 ...
 * @param eDetails A {@link groovyParallelPatterns.LocalDetails} object that specifies the data class to be emitted
 * <p>
