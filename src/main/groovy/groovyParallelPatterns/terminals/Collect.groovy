 ...
 * </pre>
 * 	<p>
 * @param input The one2one input channel used to receive results (Specified by GPP_BUILder)
 ...
 * The GPP_Builder program will initialise this channel property automatically.
 *
 *
 *
*/
