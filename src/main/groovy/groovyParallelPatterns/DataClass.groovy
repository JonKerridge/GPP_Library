...
/**
 * DataClass provides the super class for all data classes used in groovyParallelPatterns, it provides
 * a null implementation of all the abstract methods defined in DataClassInterface,
 * thus  all data classes used in groovyParallelPatterns should extend DataClass, overriding the methods
...
//			the system exits on error
  ...
  /**
   * A null implementation of {@link groovyParallelPatterns.DataClassInterface#clone()}<p>
